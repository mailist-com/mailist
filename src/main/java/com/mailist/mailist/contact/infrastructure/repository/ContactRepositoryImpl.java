...
public class ContactRepositoryImpl implements ContactRepository {
    ...
    @Override
    public Optional<Contact> findByIdAndOrganizationId(Long id, Long organizationId) {
    ...
    @Override
    public Optional<Contact> findByEmailAndOrganizationId(String email, Long organizationId) {
        return Optional.empty();
    }
    ...
    @Override
    public List<Contact> findByOrganizationId(Long organizationId) {
        return List.of();
    }

    @Override
    public Page<Contact> findByOrganizationId(Long organizationId, Pageable pageable) {
        return null;
    }

    @Override
    public List<Contact> findByTagsNameAndOrganizationId(String tagName, Long organizationId) {
        return List.of();
    }

    @Override
    public List<Contact> findByLeadScoreBetweenAndOrganizationId(int minScore, int maxScore, Long organizationId) {
        return List.of();
    }
