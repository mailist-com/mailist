package com.mailist.marketing.analytics.domain.aggregate;
...
public class Report extends BaseTenantEntity {
    ...
    private com.mailist.marketing.analytics.domain.valueobject.ReportType reportType;
    ...
    public static Report createCampaignReport(String name, String description, Long entityId, 
        ...
        return Report.builder()
                ...
                .reportType(com.mailist.marketing.analytics.domain.valueobject.ReportType.CAMPAIGN)
                .entityId(entityId)
                .reportFormat(format)
    ...
    public static Report createContactReport(String name, String description, Long entityId, 
        ...
        return Report.builder()
                .name(name)
                .description(description)
                .reportType(com.mailist.marketing.analytics.domain.valueobject.ReportType.CONTACT)
                .entityId(entityId)
                .reportFormat(format)
                .generatedBy(generatedBy)
                .periodStart(data != null ? data.getPeriodStart() : null)
    ...
    public static Report createAutomationReport(String name, String description, Long entityId, 
        ...
        return Report.builder()
                .name(name)
                .description(description)
                .reportType(com.mailist.marketing.analytics.domain.valueobject.ReportType.AUTOMATION)
                .entityId(entityId)
                .reportFormat(format)
                .generatedBy(generatedBy)
                .periodStart(data != null ? data.getPeriodStart() : null)
    ...
    public static Report createOverallReport(String name, String description, 
        ...
        return Report.builder()
                .name(name)
                .description(description)
                .reportType(com.mailist.marketing.analytics.domain.valueobject.ReportType.OVERALL)
                .reportFormat(format)
                .generatedBy(generatedBy)
                .periodStart(data != null ? data.getPeriodStart() : null)
                .periodEnd(data != null ? data.getPeriodEnd() : null)
